...
from basecore.utils.config import create_subject_list
...
input_layout = [
    [sg.Text('Input folder', size=(20, 1), auto_size_text=False, justification='right', font='Helvetica 36'),
     sg.InputText('', key='in_path', tooltip=(
         'Folder containing DICOM files in any structure.'), font='Helvetica 36'),
     sg.FolderBrowse(font='Helvetica 36')],
    [sg.Text('Working directory', size=(20, 1), auto_size_text=False,
             justification='right', font='Helvetica 36'),
     sg.InputText('', key='work_dir', tooltip=(
         'Path where to save the results. If the directory does not \n'
         'exist, it will be created.'), font='Helvetica 36'),
     sg.FolderBrowse(font='Helvetica 36')],
    [sg.Text('Number of cores', size=(20, 1), auto_size_text=False, justification='right',
            tooltip=('Number of cores to use to run PyCurt. Default is 0, which means \n'
                     'PyCurt will run linearly.'), font='Helvetica 36'),
    sg.InputText(0, key='cores', size=(20, 10), font='Helvetica 36')],
    [sg.Checkbox('Data sorting', change_submits = True, enable_events=True, size=(20, 1),
                 default=True, key='data_sorting', disabled=data_sorting, font='Helvetica 36',
    ...
    sg.Checkbox('Renaming', change_submits = True, enable_events=True, font='Helvetica 36',
    ...
    sg.Text('Subject name position', size=(20, 1), auto_size_text=False, justification='right',
            tooltip=('If "Data sorting" is selected, and "Renaming" is False, then you have \n'
                     ...
                     'i.e. -3.'), font='Helvetica 36'),
    sg.InputText(-3, key='sn_pos', disabled = data_sorting,
                 size=(15, 10), font='Helvetica 36')],
    [sg.Checkbox('Data curation', change_submits = True, enable_events=True, size=(20, 1),
                 default=True, key='data_curation', disabled=data_sorting, font='Helvetica 36',
    ...
    sg.Checkbox('Run MR images classification', change_submits = True, enable_events=True, size=(30, 1),
                 default=True, key='mrclass', disabled=data_sorting, font='Helvetica 36',
...
layout = [
    [sg.Text('PyCURT - Python-based automated data CUration Workflow for RadioTherapy data\n',
             size=(70, 1), font=("Helvetica", 48), justification='l')],
    [sg.Frame('Workflow parameters', input_layout, font='Helvetica 40', title_color='black')],
    [sg.Text('_'  * 280)],
    [sg.Submit(font='Helvetica 36'), sg.Quit(font='Helvetica 36')]
    ]
