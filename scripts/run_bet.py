...
if __name__ == "__main__":
    ...
    for sub_id in sub_list:
        ...
        datasource, sessions, reference, t10, sequences, ref_sequence = base_datasource(sub_id, BASE_DIR)
        workflow = brain_extraction(sub_id, datasource, sessions, ref_sequence, sequences,
                                    RESULT_DIR, NIPYPE_CACHE, reference, t10=t10)
