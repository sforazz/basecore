    ...
    for sub_id in sub_list:
        ...
        for i, mask in enumerate(apply_mask_nodes):
            ...
            workflow.connect(mask, 'out_file', datasink,
                             'results.subject.@{}_preproc'.format(sequences[i+1]))
